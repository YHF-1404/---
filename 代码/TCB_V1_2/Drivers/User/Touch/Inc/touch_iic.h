...
// #define Touch_IIC_SCL_CLK_ENABLE     __HAL_RCC_GPIOE_CLK_ENABLE()		// SCL 引脚时钟
// #define Touch_IIC_SCL_PORT   			 GPIOE                 				// SCL 引脚端口
// #define Touch_IIC_SCL_PIN     		 GPIO_PIN_5  							// SCL 引脚
         
// #define Touch_IIC_SDA_CLK_ENABLE     __HAL_RCC_GPIOE_CLK_ENABLE() 	// SDA 引脚时钟
// #define Touch_IIC_SDA_PORT   			 GPIOE                   			// SDA 引脚端口
// #define Touch_IIC_SDA_PIN    			 GPIO_PIN_6              			// SDA 引脚

// #define Touch_INT_CLK_ENABLE    		 __HAL_RCC_GPIOE_CLK_ENABLE()		// INT 引脚时钟
// #define Touch_INT_PORT   				 GPIOE                   			// INT 引脚端口
// #define Touch_INT_PIN    				 GPIO_PIN_4             			// INT 引脚

// #define Touch_RST_CLK_ENABLE   		 __HAL_RCC_GPIOE_CLK_ENABLE()		// RST 引脚时钟
// #define Touch_RST_PORT   				 GPIOE                   			// RST 引脚端口
// #define Touch_RST_PIN    				 GPIO_PIN_3           				// RST 引脚
